...
- จะขึ้นแค่อักษรตัวแอก เพราะตัวแปร ch จะเก็บอักษรตัวเดียว


❔ ในบรรทัดซึ่งมีโปรแกรมเป็น ch = (char)Console.Read(); นั้น ถ้าตัด (char) ออกไป จะเกิดอะไรขึ้น ให้อธิบายประกอบ
- โปรแกรม Error เพราะ ไม่ได้ทำการ cast ตัวแปร char
...
- โปรแกรม Error เพราะเขียนให้รับได้แค่อักษรทำให้ไม่สามารถรับตัวเลขได้ วิธีแก้ไขคือให้แปลงข้อมูลเป็น String
...
- โปรแกรม Error และจะบอกสาเหตุของการ Error ไว้
