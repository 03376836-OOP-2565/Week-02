...
![image](https://user-images.githubusercontent.com/115037574/213539881-01ebdc62-b08d-480d-8023-44d16408c2fd.png)

❔ ถ้าพิมพ์ตัวอักษรจำนวนหลายๆ ตัวแล้วกด Enter จะได้ผลอย่างไร ทำไมจึงเป็นเช่นนั้น
```
จะเอาตัวอักษรตัวเลขมากแสดง เพราะว่าจะเอาแค่ char(acter) ตัวแรกมา
```

❔ ในบรรทัดซึ่งมีโปรแกรมเป็น ch = (char)Console.Read(); นั้น ถ้าตัด (char) ออกไป จะเกิดอะไรขึ้น ให้อธิบายประกอบ
```
โปรแกรมจะ error เพราะ ตัวแปร ch จะเอาไว้เก็บข้อมูลที่เป็น ตัวอักษร 1 ตัวอักษร ไม่สามารถเก็บคำสั่ง Console.Read() ได้
```
...
➢ รันโปรแกรมและบันทึกผล
![image](https://user-images.githubusercontent.com/115037574/213541553-d88a82ca-f414-4826-9163-5386b3b716c0.png)
...
![image](https://user-images.githubusercontent.com/115037574/213542012-73bac7dd-576a-400d-b3c4-96f02ae23129.png)

❔ ถ้าเราป้อนตัวอักษรลงไปแทนที่ตัวเลข จะเกิดอะไรขึ้น มีวิธีการป้องกันหรือแก้ไขอย่างไร <br>
`โปรแกรมจะ Error`<br>
`วิธีแก้คือ ไม่ต้อง Convert เป็น Int (หากไม่ได้เอาค่าตัวเลขไปคำนวน) ตามโปรแกรมด้านล่าง`
```csharp
string str;
Console.Write("Please enter value 1 : ");
...
![image](https://user-images.githubusercontent.com/115037574/213545468-834f391a-e549-49d7-942c-c2b728d36d5a.png)

❔ ถ้าเราป้อนตัวอักษรลงไปแทนที่ตัวเลข จะเกิดอะไรขึ้น เหมือนหรือต่างจากโปรแกรมก่อนหน้านี้อย่างไร
```
โปรแกรมจะ Error 
แต่จะแตกต่างจากหน้านี้คือ ถ้าโปรแกรมเกิด Error โปรแกรมจะ Throwing Exceptions หรือการแสดง Error
```
...
➢ รันโปรแกรมและบันทึกผล
![image](https://user-images.githubusercontent.com/115037574/213548149-66b7813a-8fff-4ac1-9f90-532b308f77a0.png)
