...
![image](https://user-images.githubusercontent.com/115066356/213690657-1a9c2580-f64a-4165-8524-6e40a6006c24.png)
...
➢ รันโปรแกรมและบันทึกผล
![image](https://user-images.githubusercontent.com/115066356/213690951-4ac313bd-ffae-47c7-b645-0c550115594e.png)


❔ ถ้ามีการใช้ตัวเลขใน { } ที่กระโดด เช่น {0} {2} {3} จะใช้งานได้หรือไม่ อย่างไร จงอธิบาย
```
ได้ แต่ขึ้นอยู่กับตัวแปรที่กำหนด
```
...
➢ รันโปรแกรมและบันทึกผล
![image](https://user-images.githubusercontent.com/115066356/213691611-c83e0a6b-179b-4e9b-89fc-6e168a100d3a.png)
